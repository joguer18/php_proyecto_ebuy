<!-- jQuery -->
    ...
    <script src="<?php echo BASE_URL?>public/assets/bower_components/metisMenu/dist/metisMenu.min.js"></script>

    <!-- Morris Charts JavaScript -->
    <script src="<?php echo BASE_URL?>public/assets/bower_components/raphael/raphael-min.js"></script>
    <script src="<?php echo BASE_URL?>public/assets/bower_components/morrisjs/morris.min.js"></script>
    <script src="<?php echo BASE_URL?>public/assets/js/morris-data.js"></script>
